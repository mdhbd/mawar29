...
function pogody(){
	...
	/*Typed js*/
	$("#typed").typed({
		strings: [" Happy Birthday Dear!", " Wish You All The Best 😇", " ..here a little gift for you", " A slideshow of our story"," I hope the number will be increased", " 19 Oktober 2017 \n😘 "],
		typeSpeed: 100,
		backDelay: 900,
		loop: true,
		cursorChar: "|",
